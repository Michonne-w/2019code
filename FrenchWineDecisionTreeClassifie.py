...
test_sta = [(13.52,3.17,2.72,23.5,97),( 12.42,2.55,2.27,22,90),( 13.76,1.53,2.7,19.5,132)]
print(test_sta[0:3])#利用3个数据进行测试，即取3个数据作为模型的输入端
for x in model.predict(test_sta[0:3]):
    if x == 'Zinfandel':
        print('仙粉黛', end=' ')
    elif x == 'Syrah':
        print('西拉', end=' ')
    else:
        print('赤霞珠', end=' ')#输出测试的结果，即输出模型预测的结果
